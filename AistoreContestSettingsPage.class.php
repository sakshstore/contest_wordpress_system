...
function aistore_contest_page_register_setting() {
	...
	register_setting( 'aistore_contest_page', 'contest_user_id' );
	 ...
	 register_setting( 'aistore_contest_page', 'user_list_contest_page_id' );
      
	register_setting( 'aistore_contest_page', 'all_list_contest_page_id' );
...
<p><?php  _e( 'Install required plugin Escrow System link https://wordpress.org/plugins/saksh-escrow-system  and aistore wallet plugin activate as per their setup process. ', 'aistore' ) ?></p>
...
<p>Create a page add this shortcode <strong> [aistore_contest] </strong> and then select that page here. </p>
		  ...
		  <tr valign="top">
        <th scope="row"><?php  _e( 'Your Contest List page', 'aistore' ) ?></th>
        <td>
...
<p>Create a page add this shortcode <strong> [aistore_contest_list] </strong> and then select that page here. </p>
        	  ...
        	  <tr valign="top">
        <th scope="row"><?php  _e( 'User Contest List page', 'aistore' ) ?></th>
        <td>
		<select name="user_list_contest_page_id">
		  
		   <?php 
                    foreach($pages as $page){ 
					
					if($page->ID==get_option('user_list_contest_page_id'))
					{
		 echo '	<option selected value="'.$page->ID.'">'.$page->post_title .'</option>';
...
<p>Create a page add this shortcode <strong> [contest_list] </strong> and then select that page here. </p>
        	  ...
        	  <tr valign="top">
        <th scope="row"><?php  _e( 'All Contest List page', 'aistore' ) ?></th>
        <td>
		<select name="all_list_contest_page_id">
		  
		   <?php 
                    foreach($pages as $page){ 
					
					if($page->ID==get_option('all_list_contest_page_id'))
					{
		 echo '	<option selected value="'.$page->ID.'">'.$page->post_title .'</option>';
...
<p>Create a page add this shortcode <strong> [aistore_contest_list_page] </strong> and then select that page here. </p>
